angular.module('multichatApp').config(['growlProvider', function (growlProvider) {
    growlProvider.globalPosition('bottom-right');
    growlProvider.globalTimeToLive(2000);
}]);

angular.module('multichatApp').config(function (dropzoneOpsProvider) {
...
angular.module('multichatApp').config(['$compileProvider', function ($compileProvider) {
